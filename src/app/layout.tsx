...
export const metadata: Metadata = {
  ...
  description:
    "Software developer and University of Manitoba student showcasing web development projects, coding experience, and technical skills. View my portfolio and get in touch for collaboration.",
  keywords:
    "software developer, web developer, University of Manitoba, student developer, portfolio, coding projects, programming",
  authors: [{ name: "Gideon Ashiru" }],
  openGraph: {
    title: "Gideon Ashiru - Software Developer Portfolio",
    description:
      "University of Manitoba software development student showcasing projects and coding experience.",
